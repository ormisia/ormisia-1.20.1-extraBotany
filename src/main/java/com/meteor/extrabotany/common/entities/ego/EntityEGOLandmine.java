...
public class EntityEGOLandmine extends Entity {
    ...
    public EntityEGOLandmine(EntityType<EntityEGOLandmine> type, Level world) {
        super(type, world);
    }

    public EntityEGOLandmine(Level world) {
        super(ModEntities.EGOLANDMINE.get(), world);
    }

    public static void spawnLandmine(int wave, Level world, BlockPos source, EntityEGO ego){
        Vec3 vecSource = Helper.PosToVec(source);
        ...
        if (tickCount >= 50) {
            ...
            if (!level().isClientSide) {
                ...
                for (Player player : players) {
                    ...
                    player.hurt(player.damageSources().indirectMagic(this, summoner), 10F);
                    ...
                    // TODO: MobEffectInstance.getCurativeItems()/setCurativeItems() were removed in 1.20.1.
