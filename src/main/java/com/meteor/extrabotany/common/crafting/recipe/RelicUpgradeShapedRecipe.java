...
public class RelicUpgradeShapedRecipe implements CraftingRecipe {
    ...
    public static final RecipeSerializer<RelicUpgradeShapedRecipe> SERIALIZER = new Serializer();

    private static class Serializer implements RecipeSerializer<RelicUpgradeShapedRecipe> {
        @Override
        public RelicUpgradeShapedRecipe fromJson(@Nonnull ResourceLocation recipeId, @Nonnull JsonObject json) {
            return new RelicUpgradeShapedRecipe(RecipeSerializer.SHAPED_RECIPE.fromJson(recipeId, json));
        }

        @Override
        public RelicUpgradeShapedRecipe fromNetwork(@Nonnull ResourceLocation recipeId, @Nonnull FriendlyByteBuf buffer) {
            return new RelicUpgradeShapedRecipe(RecipeSerializer.SHAPED_RECIPE.fromNetwork(recipeId, buffer));
        }

        @Override
        public void toNetwork(@Nonnull FriendlyByteBuf buffer, @Nonnull RelicUpgradeShapedRecipe recipe) {
