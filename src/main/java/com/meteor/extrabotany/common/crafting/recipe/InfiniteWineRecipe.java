...
public class InfiniteWineRecipe extends CustomRecipe {
    ...
    public InfiniteWineRecipe(ResourceLocation idIn, CraftingBookCategory category) {
        super(idIn, category);
    }
        ...
        for (int i = 0; i < inv.getContainerSize(); i++) {
            ...
            if (!stack.isEmpty()) {
                if (stack.getItem() == ModItems.cocktail.get() && !foundBrew) {
                    ...
                    if (stack.getItem() == ModItems.heromedal.get()) {
                        foundItem = true;
                    } else {
                        return false;
                    }
    ...
    public ItemStack assemble(CraftingContainer inv, RegistryAccess registryAccess) {
        ...
        ItemStack wine = new ItemStack(ModItems.infinitewine.get());
