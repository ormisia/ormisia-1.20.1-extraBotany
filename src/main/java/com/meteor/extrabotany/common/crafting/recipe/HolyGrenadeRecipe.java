...
public class HolyGrenadeRecipe extends CustomRecipe {

    public static final SimpleCraftingRecipeSerializer<HolyGrenadeRecipe> SERIALIZER = new SimpleCraftingRecipeSerializer<>(HolyGrenadeRecipe::new);

    public HolyGrenadeRecipe(ResourceLocation idIn, CraftingBookCategory category) {
        super(idIn, category);
    }
    ...
    public ItemStack assemble(CraftingContainer inv, RegistryAccess registryAccess) {
        ...
        ItemStack grenade = new ItemStack(ModItems.splashgrenade.get(), 8);
