...
public class CapabilityEventHandler {
    ...
    public static void onPlayerCloned(PlayerEvent.Clone event) {
        if (!event.isWasDeath()) {
            ...
            LazyOptional<IHerrscherEnergy> newSpeedCap = ((Player) event.getEntity()).getCapability(CapabilityHandler.HERRSCHERENERGY_CAPABILITY);
            ...
            LazyOptional<IFlamescion> newFlamescionCap = ((Player) event.getEntity()).getCapability(CapabilityHandler.FLAMESCION_CAPABILITY);
